...
module.exports = (dispatch, handlers, guide, lang) => {
 ...
 let Triple_Attack = false,
	...
	return {
		...
		"rb-3036-1000": [{ type: "func", func: () => enrage = 1 },{ type: "func", func: () => start_enraged_time_A = new Date() },{ type: "text", sub_type: "message", message: "Enrage" }],
		"re-3036-1000": [{ type: "func", func: () => enrage = 0 },{ type: "text", sub_type: "message", message: "Enrage Up" }],			
		...
		"h-3036-1000-35": [{ type: "text", sub_type: "message", message: "---------------countdown--------------" }],	
		"h-3036-1000-34": [{ type: "text", sub_type: "message", message: "---------------The third layer is ready to shrink--------------" }],			
		"h-3036-1000-65": [{ type: "text", sub_type: "message", message: "----------------The second layer is ready to shrink--------------" }],	
		...
		"s-3036-1000-1114-0": [{ type: "text", sub_type: "message", message: "Invisible Fire" },			
		...
		"s-3036-1000-2114-0": [{ type: "text", sub_type: "message", message: "Invisible Fire" },
			                   { type: "spawn", func: "vector", args: [912, 90, 150, 0, 1300, 0, 5830]},
                               { type: "spawn", func: "vector", args: [912, 90, 75, 0, 1300, 0, 5830]},
                               { type: "spawn", func: "vector", args: [912, 0, 0, 0, 1300, 0, 5830]},							   
			                   { type: "spawn", func: "vector", args: [912, 270, 75, 0, 1300, 0, 5830]},
		...
		"s-3036-1000-1303-0": [{ type: "text", sub_type: "message", message: "Spin Attack" }],
		...
		"s-3036-1000-1805-0": [{ type: "text", sub_type: "message", message: "Between" },	
		...
		"s-3036-1000-2115-0": [{ type: "text", sub_type: "message", delay: 3200,  message: "Dodge" },
		...
		"s-3036-1000-1115-0": [{ type: "text", sub_type: "message", delay: 3200,  message: "Dodge" },
		                       { type: "text", sub_type: "message", message: "3" },		
		                       { type: "text", sub_type: "message", delay: 1000,  message: "2" },
		                       { type: "text", sub_type: "message", delay: 2000,  message: "1" }],			
		...
		"s-3036-1000-2118-0": [{ type: "text", sub_type: "message", message: "Front Cut | Dodge" },
								...
								{ type: "spawn", func: "semicircle", args: [310, 360, 912, 0, 0, 10, 250, 0, 2000] },
								{ type: "spawn", func: "semicircle", args: [315, 360, 912, 0, 0, 10, 340, 0, 2000] }],		
		"qb-3036-1000-3036039": [{ type: "func", func: skilld_event, args: [3036039]},{ type: "text", sub_type: "message", delay: 75000,  message: (hp_79 ? 'Four Split Strikes coming soon!!!' : 'Three Split Strikes coming soon!!!') }],		
