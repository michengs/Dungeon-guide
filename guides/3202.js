...
"s-3202-1000-105-0": [{"type": "text","sub_type": "MSG","message": "TEST","message_TW": "칼리가르_기본공격3_어퍼컷_atk03[start]_normal"}],       
...
"s-3202-1000-109-0": [{"type": "text","sub_type": "MSG","message": "TEST","message_TW": "칼리가르_광역1_발로찍기_UltraAtk01[start]_normal"}],         
"s-3202-1000-110-0": [{"type": "text","sub_type": "MSG","message": "TEST","message_TW": "칼리가르_광역2_점프 제자리찍기_터져라_UltraAtk02[start][end]_DS_normal"}],         
"s-3202-1000-111-0": [{"type": "text","sub_type": "MSG","message": "TEST","message_TW": "칼리가르_견제1_대상자지정 점프 추적 내려찍기_LongMove[start][end]_normal"}],         
"s-3202-1000-112-0": [{"type": "text","sub_type": "MSG","message": "TEST","message_TW": "칼리가르_견제2_니킥 후 돌려차기_HeavyAtk02[start][end]_normal"}],        
...
"s-3202-1000-121-0": [{"type": "text","sub_type": "MSG","message": "TEST","message_TW": "칼리가르_핵심액션1_시계방향돌고 발로찍기_Heavyatk01[start01]_normal"}],        
...
"s-3202-1000-124-0": [{"type": "text","sub_type": "MSG","message": "TEST","message_TW": "칼리가르_핵심액션1_반시계방향돌고 발로찍기_Heavyatk01[start02]_normal"}],         
