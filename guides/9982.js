...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-982-1000-106-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "重击", message_RU: "Тяжелый удар" }],
		"s-982-1000-107-0": [
			{ type: "text", class_position: "dps", sub_type: "message", message: "后扫", message_RU: "Откид (конус)" },
			{ type: "text", class_position: "heal", sub_type: "message", message: "后扫 (Kaia)", message_RU: "Откид (кайя)" }
		],
		"s-982-1000-108-0": [{ type: "text", sub_type: "message", message: "Bait (Flying)", message_RU: "Байт (подлет)" }, ],
		"s-982-1000-109-0": [{ type: "text", sub_type: "message", message: "滚石 (Small)", message_RU: "Камни (малые)" }],
		"s-982-1000-110-0": [{ type: "text", sub_type: "message", message: "滚石 (Large)", message_RU: "Камни (большие)" }],
