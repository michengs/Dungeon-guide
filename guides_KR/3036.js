 ...
 let Triple_Attack = false,
	...
	function skilld_event(skillid, ent) {                                               //1401  1701  右劈0-180            1402 1702 左 180-360
		if ([1401, 1701,1402,1702].includes(skillid)) {
			...
			handlers.event([ 			
            { type: "text", sub_type: "message", message:  (Triple_Attack ? `${mech_messages[hp_79].message}` + `${mech_direction[num].message}` : "2 연속 패배 " + `${mech_direction[num].message}`)	},			
	...
	return {
		"rb-3036-1000": [{ type: "func", func: () => enrage = 1 },{ type: "func", func: () => start_enraged_time_A = new Date() },{ type: "text", sub_type: "message", message: "보스 몬스터" }],
		"re-3036-1000": [{ type: "func", func: () => enrage = 0 },{ type: "text", sub_type: "message", message: "분노가 끝나다" }],			
		"nd-3036-1001": [{ type: "stop_timers" },{ type: "despawn_all" }],
		"s-3036-1001-1112-0": [{ type: "text", sub_type: "message", message: "후" }],
		...
		"s-3036-1000-1112-0": [{ type: "text", sub_type: "message", message: "후퇴" }],
		"s-3036-1000-1117-0": [{ type: "text", sub_type: "message", message: "전방" }],
		"s-3036-1000-1118-0": [{ type: "text", sub_type: "message", message: "베 타 | 섬광" }],
		"s-3036-1000-1302-0": [{ type: "text", sub_type: "message", message: "AOE" },
			                   { type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 500, 100, 6000]}],
		"s-3036-1000-1303-0": [{ type: "text", sub_type: "message", message: "회전 공격" }],
		...
		"s-3036-1000-1805-0": [{ type: "text", sub_type: "message", message: "가운데" },	
                               { type: "text", sub_type: "message", delay: 2100, message: "네" },	
                               { type: "text", sub_type: "message", delay: 3050, message: "취안허외" },							   
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 250, 0, 6000]},
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 6, 450, 0, 6000]}],  //650	
		"s-3036-1000-1806-0": [{ type: "text", sub_type: "message", message: "네" },	
                               { type: "text", sub_type: "message", delay: 2100, message: "가운데" },	
                               { type: "text", sub_type: "message", delay: 3050, message: "취안 | 네" },								   
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 250, 0, 6000]},
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 6, 450, 0, 6000]}], 
		"s-3036-1000-1801-0": [{ type: "text", sub_type: "message", message: "----침묵------" }],
		"s-3036-1000-2115-0": [{ type: "text", sub_type: "message", delay: 3500,  message: "번개" }],		
		"s-3036-1000-1115-0": [{ type: "text", sub_type: "message", delay: 3500,  message: "번개" }],			
		"s-3036-1000-2103-0": [{ type: "func", func: boss_backattack_event }],
		"s-3036-1000-2106-0": [{ type: "func", func: boss_backattack_event }],
		"s-3036-1000-2112-0": [{ type: "text", sub_type: "message", message: "후퇴" }],	
		"s-3036-1000-2117-0": [{ type: "text", sub_type: "message", message: "전방 " }],
		"s-3036-1000-2118-0": [{ type: "text", sub_type: "message", message: "베 티| 번개" }],		
