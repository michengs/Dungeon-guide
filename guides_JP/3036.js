 ...
 let Triple_Attack = false,
	...
	function skilld_event(skillid, ent) {                                               //1401  1701  右劈0-180            1402 1702 左 180-360
		if ([1401, 1701,1402,1702].includes(skillid)) {
			...
			handlers.event([ 			
            { type: "text", sub_type: "message", message:  (Triple_Attack ? `${mech_messages[hp_79].message}` + `${mech_direction[num].message}` : "2連割り" + `${mech_direction[num].message}`)	},			
	...
	return {
		"rb-3036-1000": [{ type: "func", func: () => enrage = 1 },{ type: "func", func: () => start_enraged_time_A = new Date() },{ type: "text", sub_type: "message", message: "boss怒り" }],
		"re-3036-1000": [{ type: "func", func: () => enrage = 0 },{ type: "text", sub_type: "message", message: "怒りが終わる" }],			
		"nd-3036-1001": [{ type: "stop_timers" },{ type: "despawn_all" }],
		"s-3036-1001-1112-0": [{ type: "text", sub_type: "message", message: "後ジャンプ" }],
		...
		"s-3036-1000-1112-0": [{ type: "text", sub_type: "message", message: "後退" }],
		"s-3036-1000-1117-0": [{ type: "text", sub_type: "message", message: "前方" }],
		"s-3036-1000-1118-0": [{ type: "text", sub_type: "message", message: "切った一撃| フラッシュ" }],
		"s-3036-1000-1302-0": [{ type: "text", sub_type: "message", message: "AOE" },
			                   { type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 500, 100, 6000]}],
		"s-3036-1000-1303-0": [{ type: "text", sub_type: "message", message: "回転攻撃" }],
		...
		"s-3036-1000-1805-0": [{ type: "text", sub_type: "message", message: "うち" },	
		...
		"s-3036-1000-1806-0": [{ type: "text", sub_type: "message", message: "内" },	
                               { type: "text", sub_type: "message", delay: 2100, message: "うち" },	
                               { type: "text", sub_type: "message", delay: 3050, message: "全 | 内" },								   
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 250, 0, 6000]},
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 6, 450, 0, 6000]}], 
		"s-3036-1000-1801-0": [{ type: "text", sub_type: "message", message: "----沈黙------" }],
		"s-3036-1000-2115-0": [{ type: "text", sub_type: "message", delay: 3500,  message: "フラッシュ" }],		
		"s-3036-1000-1115-0": [{ type: "text", sub_type: "message", delay: 3500,  message: "フラッシュ" }],			
		"s-3036-1000-2103-0": [{ type: "func", func: boss_backattack_event }],
		"s-3036-1000-2106-0": [{ type: "func", func: boss_backattack_event }],
		"s-3036-1000-2112-0": [{ type: "text", sub_type: "message", message: "後退" }],	
		"s-3036-1000-2117-0": [{ type: "text", sub_type: "message", message: "前方 " }],
		"s-3036-1000-2118-0": [{ type: "text", sub_type: "message", message: "切った一撃| フラッシュ" }],		
