...
module.exports = (dispatch, handlers, guide, lang) => {
 ...
 let Triple_Attack = false,
     ...
     total_time2 = null;		 
	const mech_messages = {
		0: { message: "Drei hintereinander" },
		1: { message: "Vier hintereinander"}
	};	
	const mech_num = {
	...
	function skilld_event(skillid, ent) {                                               //1401  1701  右劈0-180            1402 1702 左 180-360
		if ([1401, 1701,1402,1702].includes(skillid)) {
			...
			handlers.event([ 			
            { type: "text", sub_type: "message", message:  (Triple_Attack ? `${mech_messages[hp_79].message}` + `${mech_direction[num].message}` : "Zwei schläge in folge" + `${mech_direction[num].message}`)	},			
	...
	return {
		"rb-3036-1000": [{ type: "func", func: () => enrage = 1 },{ type: "func", func: () => start_enraged_time_A = new Date() },{ type: "text", sub_type: "message", message: "Der boss ist wütend." }],
		"re-3036-1000": [{ type: "func", func: () => enrage = 0 },{ type: "text", sub_type: "message", message: "Keine wut mehr." }],			
		...
		"s-3036-1000-1112-0": [{ type: "text", sub_type: "message", message: "Zurück! - hey!" }],
		"s-3036-1000-1117-0": [{ type: "text", sub_type: "message", message: "Vorbereiten" }],
		"s-3036-1000-1118-0": [{ type: "text", sub_type: "message", message: "Hieb xprop | gefahren" }],
		"s-3036-1000-1302-0": [{ type: "text", sub_type: "message", message: "AOE" },
			                   { type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 500, 100, 6000]}],
		"s-3036-1000-1303-0": [{ type: "text", sub_type: "message", message: "Wirre attacke!" }],
		...
		"s-3036-1000-1805-0": [{ type: "text", sub_type: "message", message: "Durch die mitte." },	
                               { type: "text", sub_type: "message", delay: 2100, message: "in" },	
                               { type: "text", sub_type: "message", delay: 3050, message: "Alles xprop | Von" },							   
		...
		"s-3036-1000-1806-0": [{ type: "text", sub_type: "message", message: "in" },	
                               { type: "text", sub_type: "message", delay: 2100, message: "Durch die mitte." },	
                               { type: "text", sub_type: "message", delay: 3050, message: "Alles xprop | in" },								   
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 250, 0, 6000]},
		                       { type: "spawn", func: "circle", args: [false, 553, 0, 0, 6, 450, 0, 6000]}], 
		"s-3036-1000-1801-0": [{ type: "text", sub_type: "message", message: "----Stille.------" }],
		"s-3036-1000-2115-0": [{ type: "text", sub_type: "message", delay: 3500,  message: "Zur seite!" }],		
		"s-3036-1000-1115-0": [{ type: "text", sub_type: "message", delay: 3500,  message: "Zur seite!" }],			
		"s-3036-1000-2103-0": [{ type: "func", func: boss_backattack_event }],
		"s-3036-1000-2106-0": [{ type: "func", func: boss_backattack_event }],
		"s-3036-1000-2112-0": [{ type: "text", sub_type: "message", message: "Zurück! - hey!" }],	
		"s-3036-1000-2117-0": [{ type: "text", sub_type: "message", message: "Vorbereiten " }],
		"s-3036-1000-2118-0": [{ type: "text", sub_type: "message", message: "Hieb xprop | gefahren" }],		
