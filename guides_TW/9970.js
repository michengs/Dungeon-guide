...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-970-3000-1301-0": [{ type: "text", sub_type: "message", message: "命运圈", message_RU: "Круги" }],
		"s-970-3000-2301-0": [{ type: "text", sub_type: "message", message: "命运圈", message_RU: "Круги" }],
		"s-970-3000-1110-0": [{ type: "text", sub_type: "message", message: "尾部AOE(靠前)", message_RU: "Хвост АОЕ (прыгать вперед)" }],
		"s-970-3000-2110-0": [{ type: "text", sub_type: "message", message: "尾部AOE(靠前)", message_RU: "Хвост АОЕ (прыгать вперед)" }],
		...
		"s-970-3000-1318-0": [{ type: "text", sub_type: "message", message: "吃红球!", message_RU: "Взять красную голову!" }],
		"s-970-3000-1317-0": [{ type: "text", sub_type: "message", message: "吃红球!", message_RU: "Взять красную голову!" }],
		"s-970-3000-1319-0": [{ type: "text", sub_type: "message", message: "吃红球!", message_RU: "Взять красную голову!" }],
