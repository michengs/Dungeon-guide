...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function print_mech(next, code) {
		...
		if (mech_reverse) {
			...
			message_TW += `${mech_messages[msg_b].message_TW} + ${mech_messages[msg_a].message_TW}`;			
		} else {
			...
			message_TW += `${mech_messages[msg_a].message_TW} + ${mech_messages[msg_b].message_TW}`;			
		}

		if (code) {
			message += `, Code: ${mech_reverse ? "0" : "1"}`;
			message_RU += `, Код: ${mech_reverse ? "0" : "1"}`;		
			message_TW += `, 代码: ${mech_reverse ? "0" : "1"}`;				
		}
	...
	function thirdboss_sattack_event(skillid) {
		...
		if ([1160, 1190].includes(skillid)) {
			handlers.text({ sub_type: "message", delay: delay, message: "Right Safe", message_RU: "Справа сейф", message_TW: "右安全" });
		}
		if ([1170, 1180].includes(skillid)) {
			handlers.text({ sub_type: "message",delay: delay, message: "Left Safe", message_RU: "Слева сейф", message_TW: "左安全" });
		}
		if ([1160, 1170, 1180, 1190].includes(skillid) && boss_seventy) { // <70%
			if (mech_reverse) {
				handlers.text({ sub_type: "message",message: "Triple-S | Out", message_RU: "Трипл-эска | От него", message_TW: "3s | 出" });
				handlers.text({ sub_type: "message",delay: 4500, message: "Out", message_RU: "От него", message_TW: "出" });
			} else {
				handlers.text({ sub_type: "message", message: "Triple-S | In", message_RU: "Трипл-эска | К нему", message_TW: "3s | 进" });
				handlers.text({ sub_type: "message", delay: 4500, message: "In", message_RU: "К нему", message_TW: "进" });
			}
	...
	return {
		...
		"qb-3034-1000-3034101": [{ type: "text", sub_type: "message", message: "Pizza", message_RU: "Пицца", message_TW: "披萨" }],
		"qb-3034-1000-3034102": [{ type: "text", sub_type: "message", message: "AOE! Jump", message_RU: "AOE! Прыгай!!!", message_TW: "AOE! 跳" }],
		"s-3034-1000-104-0": [{ type: "text", sub_type: "message", message: "Front Clip", message_RU: "Передний зажим", message_TW: "前方" }],
		"s-3034-1000-108-0": [{ type: "text", sub_type: "message", message: "Get Out", message_RU: "От него", message_TW: "远离" }], // крутилка
		"s-3034-1000-111-0": [{ type: "text", sub_type: "message", message: "Back + Front", message_RU: "Удар назад + вперед", message_TW: "后 + 前" }],
		"s-3034-1000-112-0": [{ type: "text", sub_type: "message", message: "Back", message_RU: "Удар назад", message_TW: "后" }],
		"s-3034-1003-205-0": [{ type: "text", sub_type: "message", message: "Wind (Kaia)", message_RU: "Ветер (кайя)!", message_TW: "补师开盾" }],
		...
		"s-3034-1000-304-0": [{ type: "text", sub_type: "message", message: "Out", message_RU: "От него", message_TW: "出" }],
		"s-3034-1000-305-0": [{ type: "text", sub_type: "message", message: "In", message_RU: "К нему", message_TW: "进" }],
		"s-3034-1000-306-0": [{ type: "text", sub_type: "message", message: "Bombs", message_RU: "Бомбы", message_TW: "炸弹" }],
		"s-3034-1000-307-0": [{ type: "text", sub_type: "message", message: "Pull", message_RU: "Стяжка", message_TW: "拉人" }],
		"s-3034-1000-309-0": [
			{ type: "text", sub_type: "message", message: "Four Missile", message_RU: "Запуск 4 ракет", message_TW: "导弹发射" },
			...
			{ type: "text", sub_type: "message", delay: 11000, message: "Jump", message_RU: "Прыгай!", message_TW: "跳" }
		],
		"s-3034-1000-311-0": [
			{ type: "text", sub_type: "message", message: "Safe right front", message_RU: "Справа спереди сейф", message_TW: "右前安全" },
			{ type: "spawn", func: "marker", args: [false, 67, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-312-0": [
			{ type: "text", sub_type: "message", message: "Safe right back", message_RU: "Справа сзади сейф", message_TW: "右后安全" },
			{ type: "spawn", func: "marker", args: [false, 112, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-313-0": [
			{ type: "text", sub_type: "message", message: "Safe back left", message_RU: "Сзади слева сейф", message_TW: "后左安全" },
			{ type: "spawn", func: "marker", args: [false, 202, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-314-0": [
			{ type: "text", sub_type: "message", message: "Safe front left", message_RU: "Спереди слева сейф", message_TW: "前左安全" },
			{ type: "spawn", func: "marker", args: [false, 337, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-315-0": [
			{ type: "text", sub_type: "message", message: "Safe front right", message_RU: "Спереди справа сейф", message_TW: "前右安全" },
			{ type: "spawn", func: "marker", args: [false, 22, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-316-0": [
			{ type: "text", sub_type: "message", message: "Safe back right", message_RU: "Сзади справа сейф", message_TW: "后右安全" },
			{ type: "spawn", func: "marker", args: [false, 157, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-317-0": [
			{ type: "text", sub_type: "message", message: "Safe left back", message_RU: "Слева сзади сейф", message_TW: "左后安全" },
			{ type: "spawn", func: "marker", args: [false, 247, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-318-0": [
			{ type: "text", sub_type: "message", message: "Safe left front", message_RU: "Слева спереди сейф", message_TW: "左前安全" },
			{ type: "spawn", func: "marker", args: [false, 292, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-319-0": [
			{ type: "text", sub_type: "message", message: "Safe front right", message_RU: "Спереди справа сейф", message_TW: "前右" },
			{ type: "spawn", func: "marker", args: [false, 22, 120, 100, 12000, true, null] }
		],
		"s-3034-1000-320-0": [
			{ type: "text", sub_type: "message", message: "Safe back right", message_RU: "Сзади справа сейф", message_TW: "后右安全" },
		...
		"s-3034-2000-102-0": [
			{ type: "text", sub_type: "message", message: "Pizza Cutter", message_RU: "Пила", message_TW: "披萨切割" },
		...
		"s-3034-2000-305-0": [
			{ type: "text", sub_type: "message", message: "In | Out", message_RU: "К нему | От него", message_TW: "进 | 出" },
		...
		//
		"s-3034-3000-125-0": [{ type: "text", sub_type: "message", message: "Front", message_RU: "Удар вперед", message_TW: "前方" }],
		"s-3034-3000-126-0": [{ type: "text", sub_type: "message", message: "Front | Back", message_RU: "Удар вперед | Удар назад", message_TW: "前 | 后" }],
		"s-3034-3000-127-0": [{ type: "text", sub_type: "message", message: "Back", message_RU: "Удар назад", message_TW: "后" }],
		"s-3034-3000-128-0": [
			{ type: "text", sub_type: "message", message: "Combo | Back Wave", message_RU: "Комба | Конус назад", message_TW: "连击 | 后波" },
			{ type: "spawn", func: "vector", args: [553, 180, 40, 120, 1200, 2000, 3000] },
			{ type: "spawn", func: "vector", args: [553, 180, 40, 240, 1200, 2000, 3000] }
		],
		"s-3034-3000-129-0": [{ type: "text", class_position:"tank", sub_type: "message", message: "Dodge", message_RU: "Эвейд", message_TW: "闪" }],
		...
		"s-3034-3000-321-0": [
			...
			{ type: "text", sub_type: "message", delay: 105000, message: "Shield in 10 seconds!", message_RU: "Через 10 сек. Щит!", message_TW: "10秒准备破盾" }
		],
		"s-3034-3001-308-0": [
		...
		// Radar
		"qb-3034-3000-3034312": [{ type: "text", sub_type: "message", message: "!!! Radar !!!", message_RU: "!!! Радар !!!", message_TW: "！！雷达！！" }],
		"s-3034-3000-324-0": [
			{ type: "text", sub_type: "message", message: "OUT", message_RU: "ОТ НЕГО", message_TW: "出" },
		...
		"s-3034-3000-325-0": [
			{ type: "text", sub_type: "message", message: "IN", message_RU: "К НЕМУ", message_TW: "进" },
